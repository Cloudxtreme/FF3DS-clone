...
//---------------------------------------------------------------------------------
	...
	C3D_ImmDrawBegin(GPU_TRIANGLES);
		C3D_ImmSendAttrib(x, y, 1.0f, 0.0f); // v0=position
		C3D_ImmSendAttrib( left, top, 0.0f, 0.0f);

		C3D_ImmSendAttrib(x+width, y+height, 1.0f, 0.0f);
		C3D_ImmSendAttrib( right, bottom, 0.0f, 0.0f);

		C3D_ImmSendAttrib(x+width, y, 1.0f, 0.0f);
		C3D_ImmSendAttrib( right, top, 0.0f, 0.0f);

		C3D_ImmSendAttrib(x, y, 1.0f, 0.0f); // v0=position
		C3D_ImmSendAttrib( left, top, 0.0f, 0.0f);

		C3D_ImmSendAttrib(x, y+height, 1.0f, 0.0f);
...
//---------------------------------------------------------------------------------
	...
	lodepng_decode32(&image, &width, &height, ogar_png, ogar_png_size);
...
//---------------------------------------------------------------------------------
	...
	drawSprite( player.x >> 8, player.y >> 8, 64, 64, player.image);
